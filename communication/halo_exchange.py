...
from google3.third_party.tensorflow.contrib.tpu.python.ops import tpu_ops  # pylint: disable=g-direct-tensorflow-import
...
def _alias_inplace_update(x, plane, low):
  return lambda: tf.alias_inplace_update(x, plane, tf.squeeze(low))
