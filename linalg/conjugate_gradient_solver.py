...
1. The numpy version of the CG solver at:
   google3/research/simulation/tensorflow/fluid/imaging/conjugate_gradient_solver.py
2. Preconditioner of the CG solver at:
   google3/third_party/tensorflow/contrib/solvers/python/ops/linear_equations.py
"""
...
def conjugate_gradient_solver(
    ...
    dot: common_ops.Dot,
    b: common_ops.StateVariable,
    max_iterations: int,
    tol: tf.Tensor,
    x0: common_ops.StateVariable,
    l2_norm_reduction: bool = False,
    component_wise_distance_fn: Optional[Callable[[common_ops.StateVariable],
                                                  tf.Tensor]] = None,
